...
<head>
    ...
    <title>{{ $title ?? config('app.name') }} - Admin E-Commerce</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #fe9a3c;">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto text-center">
                    <span>Copyright &copy; Yoga Firmansyah 2024 </span>
                </div>
            </footer>
            <!-- End of Footer -->
